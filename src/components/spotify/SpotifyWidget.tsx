...
export default function SpotifyWidget() {
  ...
  const [pos, setPos] = useState({ x: 32, y: 32 }); // distance from bottom-right
  ...
  // MINIMIZED — just a floating music icon
  if (minimized) return (
    <div
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <button onClick={() => setOpen(o => !o)} style={{
            background: "rgba(249,123,92,0.12)",
            border: "none", borderRadius: "50%",
            width: "26px", height: "26px",
            color: "#f97b5c", cursor: "pointer", fontSize: "0.7rem",
          ...
          <button onClick={() => setMinimized(true)} style={{
            ...
            border: "none", borderRadius: "50%",
            width: "26px", height: "26px",
            color: "#f97b5c", cursor: "pointer", fontSize: "0.8rem",
            display: "flex", alignItems: "center", justifyContent: "center",
          }} title="Minimize">
            —
          </button>
